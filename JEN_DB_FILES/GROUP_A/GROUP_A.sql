create or replace database GROUP_A COMMENT='Internal IUF department/group';
...
create or replace schema TEST_DELAY;
alter database GROUP_A set tag GROUP_A.PUBLIC.INSTANCE='prd', GROUP_A.PUBLIC.VISIBILITY='department';
